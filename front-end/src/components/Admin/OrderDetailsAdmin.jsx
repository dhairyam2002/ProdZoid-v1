      ...
      {loader ? <Loader /> : (
        <Fragment>
          <div className='orders-status'>
            ...
            <h5 >Status: {orderDetails.orderStatus === "processing" ? "Processing" : "Delivered"}</h5>
          ...
          <div className='actions-btn back-btn'>
            ...
            {orderDetails.orderStatus === "processing" && <button className = 'confirm-delivery-btn'onClick={handleGoBack}>
              <div>
                Confirm Delivery!
              </div>
            </button>}
